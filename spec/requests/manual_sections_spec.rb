...
describe 'manual sections resource' do
  ...
  it 'confirms update of the manual section' do
    ...
    expect(response.headers['Location']).to include('/guidance/employment-income-manual/12345')
    expect(response.body).to include('/guidance/employment-income-manual/12345')
  end
